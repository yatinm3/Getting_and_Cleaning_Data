...
The final tidy dataset (tidyData.txt) was created off an interim tidy dataset mergedData.txt 
generated by the R script, which is the result of merging and cleaning the untidy raw data. This 
interim dataset is also made available on github repo since it can be the source for other 
